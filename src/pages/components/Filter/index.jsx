      ...
      <Container className='d-flex flex-column container-filter'>
        <Accordion>
          <Accordion.Header>
            ...
            >
              <path
                d='M0 10C0 4.47715 4.47715 0 10 0H82C87.5229 0 92 4.47715 92 10V31C92 36.5228 87.5229 41 82 41H10C4.47715 41 0 36.5228 0 31V10Z'
                fill='#F6F6F6'
              />
              <path
                d='M18.3333 28V22.1667'
                stroke='black'
                stroke-width='1.5'
          ...
          <Accordion.Body className='d-flex flex-column gap-2'>
            ...
            <Container className='d-flex align-items-center justify-content-center my-4 mx-0 p-0'>
              <Button size='lg' className='buttons-categories apply p-2'>
                Apply Filters
              </Button>
            </Container>
          </Accordion.Body>
