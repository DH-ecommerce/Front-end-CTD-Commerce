...
export default function CardCart({ items, product, onAddItemCart, onRemoveItemCart }) {
    return (
        <Col sm={12}>
            <Card>
                ...
                <Card.Body>
                    ...
                    <div className="btns-card-cart-div">
                        <div className="btn-quantity">
                            <button onClick={onRemoveItemCart.bind(null, product.id)}><img src={remove} alt="" /></button>
                            <p className="quantity-p">{items[product.id]?.quantity || 0}</p>
                            <button onClick={onAddItemCart.bind(null, product)}><img src={add} alt="" /></button>
                        </div>
                        <img src={bin} alt="" />
                    </div>
                </Card.Body>
