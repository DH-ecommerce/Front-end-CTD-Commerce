...
export default function CardCart({ items, product, onAddItemBag, onRemoveItemBag }) {
    return (
        <Col sm={12}>
            <Card>
                ...
                <Card.Body>
                    ...
                    <div className="btns-card-cart-div">
                        <div className="btn-quantity">
                            <button onClick={onRemoveItemBag.bind(null, product.id)}><img src={remove} alt="" /></button>
                            <p className="quantity-p">{items[product.id]?.quantity || 0}</p>
                            <button onClick={onAddItemBag.bind(null, product)}><img src={add} alt="" /></button>
                        </div>
                        <img src={bin} alt="" />
                    </div>
                </Card.Body>
